...
// Thrust coefficients
#define THRUST_MIN      0.03f // TODO, value is for the legacy propellers
#define THRUST_MAX      0.1625f // TODO, value is for the legacy propellers
#define THRUST2TORQUE   0.0049f // TODO, value is for the legacy propellers
